package com.swisscom.junit.one.component.models;
...
@Component
public class ComponentStudentGrades {
    ...
    public ComponentStudentGrades() {
    }

    public ComponentStudentGrades(List<Double> mathGradeResults) {
